        ...
        @foreach ($family_members as $member)
            <div class="bg-gray-100 p-4 rounded shadow ">
                ...
                <p><strong>Confirmation
                        Date:</strong>{{ \Carbon\Carbon::parse($member->confirmation_date)->format('d/m/Y') }} </p>
                <p><strong>Member of Parish Since:</strong>
                    {{ \Carbon\Carbon::parse($member->member_of_parish_since)->format('d/m/Y') }}</p>
